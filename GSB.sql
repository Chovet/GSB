...
('a131',	'10',	0,	0.00,	'2019-11-06',	'CL'),
('a131',	'11',	0,	0.00,	'2019-11-06',	'CR');
...
CREATE TABLE `LigneFraisHorsForfait` (
  ...
  CONSTRAINT `LigneFraisHorsForfait_ibfk_3` FOREIGN KEY (`idpaiement`) REFERENCES `ModeDePaiement` (`id`) ON DELETE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

INSERT INTO `LigneFraisHorsForfait` (`id`, `idVisiteur`, `mois`, `libelle`, `date`, `montant`, `idpaiement`) VALUES
(1,	'a131',	'10',	'23948',	'2019-09-12',	4589.00,	1),
(2,	'a131',	'10',	'2134566',	'2019-09-01',	4589.00,	3),
(3,	'a131',	'10',	'23948',	'2019-09-04',	8758568.00,	1),
(8,	'a131',	'11',	'2134566',	'2019-09-12',	8758568.00,	1);
